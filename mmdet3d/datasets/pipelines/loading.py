...
class LoadMultiViewImageFromFiles(object):
    ...
    def __init__(self, to_float32=False, color_type='unchanged',file_client_args=None):
    ...
    def __call__(self, results):
        ...
        # load image through disk or ceph
        img = self.load_image(filename, self.color_type)
        if self.to_float32:
